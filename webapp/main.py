...
def telemetry():
    # Stub: en la nube no hay dron/SITL. El control real del dron está en la
    # versión local (rama 'local'), que se conecta a Mission Planner.
    return {"state": "idle", "telemetry": {}, "backend": "stub"}
